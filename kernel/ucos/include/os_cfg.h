...
#define OS_MAX_EVENTS            EVENTS_MAX   /*36default Max. number of event control blocks in your application      */
...
#define OS_MAX_QS                 MSG_QUEUE_MAX   /* Max. number of queue control blocks in your application      */


#define OS_MAX_TASKS             TASKS_MAX   /* Max. number of tasks in your application, MUST be >= 2       */

#define OS_SCHED_LOCK_EN          1u   /* Include code for OSSchedLock() and OSSchedUnlock()           */

#define OS_TICK_STEP_EN           1u   /* Enable tick stepping feature for uC/OS-View                  */
#define OS_TICKS_PER_SEC          OS_TICK_RATE_HZ   /* Set the number of ticks in one second                        */
...
#define OS_TMR_CFG_MAX           TIMER_MAX   /*16     Maximum number of timers                                 */
