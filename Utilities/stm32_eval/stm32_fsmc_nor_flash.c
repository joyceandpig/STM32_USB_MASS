...
/******************************************************************************
* Function Name  : FSMC_NOR_Read_Device_Size
* Description    : Reads NOR Device Size.
* Input          : None
* Output         : None
* Return         : Device size = 2N Bytes (15H = 21; 221 = 2 MBytes)
*******************************************************************************/
...
{	
  ...
  NOR_WRITE(ADDR_SHIFT(0x05555), 0x00AA);
  NOR_WRITE(ADDR_SHIFT(0x02AAA), 0x0055);
  NOR_WRITE(ADDR_SHIFT(0x05555), 0x0098);

  Device_Size = *(vu16 *) ADDR_SHIFT(0x0027);
